...
import "./GovernorVotesInitializable.sol";
 ...
 */
abstract contract GovernorVotesQuorumFractionInitializable is GovernorVotesInitializable {
    ...
    bool GovernorVotesQuorumFraction_initialized;
     ...
     */
    function GovernorVotesQuorumFraction_initialize(uint256 quorumNumeratorValue) public {
        require(GovernorVotesQuorumFraction_initialized == false, "GovernorVotesQuorumFraction: Already initialized");
        _updateQuorumNumerator(quorumNumeratorValue);
        GovernorVotesQuorumFraction_initialized = true;
    }
