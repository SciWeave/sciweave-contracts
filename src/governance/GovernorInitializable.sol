 ...
 */
abstract contract GovernorInitializable is Context, ERC165, EIP712Initializable, IGovernor, IERC721Receiver, IERC1155Receiver {
     ...
     */
    function Governor_intialize(string memory name_) public {
        require(governor_initialized == false, "Governor: Already initialized");
        _name = name_;
        EIP712_initialize(name_, version());
